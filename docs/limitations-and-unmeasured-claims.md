...
- A 10,000-account **synthetic** core population reproduces eight AER/ESC marginal targets within declared tolerances. Its joint structure, tariff eligibility and use of state priors for two distributor footprints are assumptions. No real customer records, ground truth, risk model or compliance control exist. CI checks software boundaries and repeatable calibration, not business performance. Consumption, seasonality and breach scenarios remain incomplete; Victorian life-support prevalence is unmeasured.
