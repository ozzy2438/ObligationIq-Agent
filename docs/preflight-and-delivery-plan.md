...
- SQLite implements the Phase 0 ledger/log and Phase 1 local corpus. Local CPU embeddings are implemented under ADR-004. Phase 2 adds 32 draft obligations in local Delta Lake. Unity Catalog, human-approved obligation records, control implementations, risk models, agents, MCP and a business evaluation corpus remain later work. [Phase 2 review gates](phase-2-register.md) must be resolved before Phase 3.
